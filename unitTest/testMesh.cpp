...
void testNeutronPrecursorsFlow(){
   ...
   coeff(0,3)  = 2.8054E-03, coeff(0,4)  = 8.1466E-04, coeff(0,5)  = 2.8792E-04;
	...
	// Sets the y velocity
	model.setConstantYVelocity(2.15*3.28, 0);
	model.setConstantYVelocity(2.35*3.38, 1);
	model.setConstantYVelocity(2.05*3.38, 2);
	model.setConstantYVelocity(1.95*3.38, 3);
	model.setConstantYVelocity(1.9*3.38, 4);
	model.setConstantYVelocity(1.85*3.38, 5);
	model.setConstantYVelocity(1.8*3.38, 6);
	...
	for (int i = 0; i < xCells; i++){
		for (int j = 0; j < yCells; j++){
			scale = ((float)xCells)/((float)i+1.0)/((float)xCells);
